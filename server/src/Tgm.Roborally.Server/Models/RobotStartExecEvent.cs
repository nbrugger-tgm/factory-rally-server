...
namespace Tgm.Roborally.Server.Models {
	...
	/// </summary>
	[DataContract]
	public class RobotStartExecEvent : IEquatable<RobotStartExecEvent>, Event {
		/// <summary>
		...
		public static bool operator ==(RobotStartExecEvent left, RobotStartExecEvent right) => Equals(left, right);
