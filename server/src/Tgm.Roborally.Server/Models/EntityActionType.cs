...
namespace Tgm.Roborally.Server.Models {
	/// <summary>
	///     Defines the action itsselft (what the action is doing)  `pass` means that nothing is done and the action wont
	///     happen  If a type starts with `edit` then all actions within the domain of the second word (eg. remove, add,
	///     change) are adressed
	/// </summary>
	/// <value>
	///     Defines the action itsselft (what the action is doing)  `pass` means that nothing is done and the action wont
	...
	public enum EntityActionType {
		...
		/// <summary>
		///     Enum BuyUpgrade for buy upgrade
		/// </summary>
		[EnumMember(Value = "buy upgrade")] BuyUpgrade = 14,

		/// <summary>
		///     Enum EditRegister for edit register
		/// </summary>
		[EnumMember(Value = "edit register")] EditRegister = 15
	}
}