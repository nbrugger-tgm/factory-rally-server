...
namespace Tgm.Roborally.Server.Models {
	...
	/// </summary>
	[DataContract]
	public class GamePhaseChangedEvent : IEquatable<GamePhaseChangedEvent>, Event {
		/// <summary>
		///     Gets or Sets Phase
		/// </summary>
		[Required]
		...
		/// <summary>
		///     Unspecified information about the game phase (you can also obtain this information in a typesave way using the
		///     GameAPI)
		/// </summary>
		/// <value>
		///     Unspecified information about the game phase (you can also obtain this information in a typesave way using the
		...
		public static bool operator ==(GamePhaseChangedEvent left, GamePhaseChangedEvent right) => Equals(left, right);
