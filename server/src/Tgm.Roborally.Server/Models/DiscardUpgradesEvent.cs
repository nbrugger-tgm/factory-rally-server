...
{ 
	...
	/// </summary>
	[DataContract]
	public partial class DiscardUpgradesEvent : IEquatable<DiscardUpgradesEvent>,Event
	{
		/// <summary>
		...
		public static bool operator ==(DiscardUpgradesEvent left, DiscardUpgradesEvent right)
		{
