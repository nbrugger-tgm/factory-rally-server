...
namespace Tgm.Roborally.Server.Models {
	...
	public class PushEvent : IEquatable<PushEvent>, Event {
		...
		///     will be autogenerated by the api and is read only
		/// </value>
		[DataMember(Name = "pusher-id", EmitDefaultValue = true)]
		...
		[DataMember(Name = "ammount", EmitDefaultValue = true)]
		public int Ammount { get; set; }

		/// <summary>
		///     Gets or Sets PushDirecton
		/// </summary>
		[DataMember(Name = "push-directon", EmitDefaultValue = true)]
		...
		///     will be autogenerated by the api and is read only
		/// </value>
		[DataMember(Name = "pushed-id", EmitDefaultValue = true)]
