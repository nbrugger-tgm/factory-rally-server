...
namespace Tgm.Roborally.Server.Controllers {
	...
	public class EventHandlingApiController : ControllerBase {
		...
		public virtual IActionResult FetchNextDamageEvent([FromRoute(Name = "game_id")] [Required] [Range(0, 2048)]
														  int gameId) {
		...
		public virtual IActionResult FetchNextLazerHitEvent([FromRoute(Name = "game_id")] [Required] [Range(0, 2048)]
															int gameId) {
		...
		public virtual IActionResult FetchNextMapEvent([FromRoute(Name = "game_id")] [Required] [Range(0, 2048)]
													   int gameId) {
		...
		public virtual IActionResult FetchNextMovementEvent([FromRoute(Name = "game_id")] [Required] [Range(0, 2048)]
															int gameId) {
		...
		public virtual IActionResult FetchNextPushEvent([FromRoute(Name = "game_id")] [Required] [Range(0, 2048)]
														int gameId) {
		...
		public virtual IActionResult FetchNextShootEvent([FromRoute(Name = "game_id")] [Required] [Range(0, 2048)]
														 int gameId) {
		...
		public virtual IActionResult FetchNextShutdownEvent([FromRoute(Name = "game_id")] [Required] [Range(0, 2048)]
															int gameId) {
