...
namespace Example
{
    public class Example
    {
        public static void Main()
        {
            ...
            Configuration.Default.ApiKey.Add("pat", "YOUR_API_KEY");
            // Uncomment below to setup prefix (e.g. Bearer) for API key, if needed
            // Configuration.Default.ApiKeyPrefix.Add("pat", "Bearer");
...
## Documentation for Models
 ...
 - [Model.GamePhaseChangeEvent](docs/GamePhaseChangeEvent.md)
