...
${nuget_cmd} install src/Tgm.Roborally.Api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Tgm.Roborally.Api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Tgm.Roborally.Api.dll \
-recurse:'src/Tgm.Roborally.Api/*.cs' \
-doc:bin/Tgm.Roborally.Api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Tgm.Roborally.Api.dll was created successfully"
fi
