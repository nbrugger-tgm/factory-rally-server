...
namespace Tgm.Roborally.Api.Model
{
    ...
    public partial class RobotInfo :  IEquatable<RobotInfo>, IValidatableObject
    {
        ...
        public RobotInfo(Direction direction = default(Direction), string name = default(string), int id = default(int), Position location = default(Position), int energyCubes = 3, int health = 10, bool active = true, bool _virtual = false, int priority = default(int), bool onTurn = default(bool), bool isMine = default(bool), int handCards = default(int), int attitude = 0, Robots? type = default(Robots?))
        {
            ...
            if (direction == null)
            {
                throw new InvalidDataException("direction is a required property for RobotInfo and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for RobotInfo and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (location == null)
            {
                throw new InvalidDataException("location is a required property for RobotInfo and cannot be null");
            }
            else
            {
            ...
            this.Id = id;
            // use default value if no "energyCubes" provided
            if (energyCubes == null)
            {
                this.EnergyCubes = 3;
            }
            ...
            // use default value if no "health" provided
            if (health == null)
            {
                this.Health = 10;
            }
            ...
            // use default value if no "attitude" provided
            if (attitude == null)
            {
                this.Attitude = 0;
            }
