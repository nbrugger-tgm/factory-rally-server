...
namespace Tgm.Roborally.Api.Api
{
    ...
    public partial class PlayersApi : IPlayersApi
    {
        ...
        {
             Tgm.Roborally.Api.Client.ApiResponse<JoinResponse> localVarResponse = JoinWithHttpInfo(gameId, password);
             return localVarResponse.Data;
        }
        ...
        /// <param name="password">The password of the game if the lobby is password protected (optional)</param>
        /// <returns>ApiResponse of JoinResponse</returns>
        public Tgm.Roborally.Api.Client.ApiResponse< JoinResponse > JoinWithHttpInfo (int gameId, string password = default(string))
        {
            Tgm.Roborally.Api.Client.RequestOptions localVarRequestOptions = new Tgm.Roborally.Api.Client.RequestOptions();
        ...
        {
             Tgm.Roborally.Api.Client.ApiResponse<JoinResponse> localVarResponse = await JoinAsyncWithHttpInfo(gameId, password);
             return localVarResponse.Data;
        ...
        /// <param name="password">The password of the game if the lobby is password protected (optional)</param>
        /// <returns>Task of ApiResponse (JoinResponse)</returns>
        public async System.Threading.Tasks.Task<Tgm.Roborally.Api.Client.ApiResponse<JoinResponse>> JoinAsyncWithHttpInfo (int gameId, string password = default(string))
        {
